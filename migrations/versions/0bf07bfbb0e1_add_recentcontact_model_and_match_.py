...
down_revision: Union[str, None] = '20251002_001'
...
def upgrade() -> None:
    ...
    op.create_table('recent_contacts',
    ...
    op.alter_column('ai_hints', 'id',
               existing_type=sa.INTEGER(),
               type_=sa.BigInteger(),
               existing_nullable=False,
               autoincrement=True)
    op.alter_column('ai_hints', 'chat_session_id',
               existing_type=sa.INTEGER(),
               type_=sa.BigInteger(),
               existing_nullable=False)
    op.alter_column('ai_hints', 'hint_type',
               existing_type=sa.VARCHAR(length=32),
               type_=sa.String(length=16),
               existing_nullable=False)
    op.alter_column('ai_hints', 'accepted',
    ...
    op.alter_column('chat_sessions', 'match_id',
               existing_type=sa.INTEGER(),
               type_=sa.BigInteger(),
               existing_nullable=False)
    ...
    op.alter_column('safety_flags', 'id',
               existing_type=sa.INTEGER(),
               type_=sa.BigInteger(),
               existing_nullable=False,
               autoincrement=True)
    op.alter_column('safety_flags', 'chat_session_id',
               existing_type=sa.INTEGER(),
               type_=sa.BigInteger(),
               existing_nullable=False)
    op.alter_column('safety_flags', 'label',
    ...
    op.alter_column('tips', 'id',
               existing_type=sa.INTEGER(),
               type_=sa.BigInteger(),
               existing_nullable=False,
               autoincrement=True)
    op.alter_column('tips', 'match_id',
               existing_type=sa.INTEGER(),
               type_=sa.BigInteger(),
               existing_nullable=False)
    op.alter_column('tips', 'amount_minor',
               existing_type=sa.INTEGER(),
               type_=sa.BigInteger(),
               existing_nullable=False)
    op.alter_column('tips', 'currency',
               ...
               existing_nullable=False)
    op.alter_column('tips', 'provider_fee_minor',
               existing_type=sa.INTEGER(),
               type_=sa.BigInteger(),
               existing_nullable=False)
    op.alter_column('tips', 'our_commission_minor',
               existing_type=sa.INTEGER(),
               type_=sa.BigInteger(),
               existing_nullable=False)
    op.alter_column('tips', 'status',
               existing_type=sa.VARCHAR(length=32),
               type_=sa.String(length=16),
               existing_nullable=False)
...
def downgrade() -> None:
    ...
    op.alter_column('tips', 'id',
               ...
               existing_nullable=False,
               autoincrement=True)
    op.create_foreign_key(op.f('safety_flags_chat_session_id_fkey'), 'safety_flags', 'chat_sessions', ['chat_session_id'], ['id'], ondelete='CASCADE')
    op.create_foreign_key(op.f('safety_flags_user_id_fkey'), 'safety_flags', 'users', ['user_id'], ['id'], ondelete='CASCADE')
    ...
    op.create_foreign_key(op.f('chat_sessions_match_id_fkey'), 'chat_sessions', 'matches', ['match_id'], ['id'], ondelete='CASCADE')
    ...
    op.create_foreign_key(op.f('ai_hints_chat_session_id_fkey'), 'ai_hints', 'chat_sessions', ['chat_session_id'], ['id'], ondelete='CASCADE')
